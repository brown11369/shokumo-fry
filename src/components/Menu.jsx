        ...
        <>
            ...
            <header className="box header">
                <div className="container">
                    ...
                    <div className="header-link">
                        ...
                        <details>
                        <summary>
                        <span className="user-name"><i className="fas fa-user-circle"></i>{user?.name}</span>
                        </summary>
                        <span className="dropdown-box">
                        <Link className="bold-nav-link dropdown-nav" to="/account">Account</Link>
                        <Link className="bold-nav-link dropdown-nav" to="/order">Order</Link>
                        <Link className="bold-nav-link dropdown-nav" onClick={logout}><i className="fas fa-sign-out"></i>Log Out</Link>
                        </span>
                        </details>
            ...
            <nav className="box navigation">
                <div className="nav container">
                    <div className="prime-navigation-link res-nav-link">
